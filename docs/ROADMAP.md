...
- [ ] Hosted session verification + actual Next/Vercel route binding/deployment of the landed Web composition, including the concrete session/CSRF provider and operational rate-limit store.
