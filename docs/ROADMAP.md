...
- [ ] Hosted auth/session verification + actual Next/Vercel route binding/deployment of the landed Web handlers, including session/CSRF policy, rate limiting and origin controls.
